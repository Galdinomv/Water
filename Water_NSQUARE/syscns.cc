#ifndef __WATER_SYSCNS_IMPL__
#define __WATER_SYSCNS_IMPL__
...
void SYSCNS(void){
	...
	// computed as being large enough to handle the input number of water molecules
	...
	// sqrt of cutoff radius; max of BOXH and default (= 0); i.e. CUTOFF
	// radius is set to half the normalized box length
	...
	// square of cutoff radius, used to actually decide whether an interaction should 
	//be computed in INTERF and POTENG
	CUT2=CUTOFF*CUTOFF;       
